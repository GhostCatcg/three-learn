...
// import { GLTFLoader } from "three/examples/jsm/loaders/GLTFLoader.js"; // 引入模型加载器
// import { OrbitControls } from "three/examples/jsm/controls/OrbitControls.js"; // 引入鼠标控制


import { GLTFLoader } from "@/static/three/examples/jsm/loaders/GLTFLoader"; // 引入模型加载器
import { OrbitControls } from "@/static/three/examples/jsm/controls/OrbitControls"; // 引入鼠标控制
